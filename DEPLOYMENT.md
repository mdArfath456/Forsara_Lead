...
5. **Deploy**
   ...
   - Note your Render URL (e.g., `https://forsara-lead.onrender.com`)
...
After backend deployment, create an admin user with your chosen credentials.

**Option A: Using Render Shell** (Recommended for production)
1. Go to Render dashboard → Your service
2. Click "Shell" tab
3. Run: `npm run seed:admin <username> <password>`
   - Example: `npm run seed:admin admin forsara123!`
...
### Recommended Seeded Credentials for Testing
...
**To seed these locally:**
```bash
node src/scripts/seedAdmin.js admin forsara123!
```

**For production deployment via Render Shell:**
```bash
npm run seed:admin admin forsara123!
```

⚠️ **Security Note**: After deploying to production, change these credentials immediately! Use a strong, unique password for production.

### Test the Deployment

1. **Frontend**: Visit your Vercel URL
2. **Login**: Use the seeded credentials (admin / forsara123!)
